...
```json
{
  ...
  "msgbrokerName" : "wfd-rmq",
  "dbType" : "h2",
  "cacheType" : "inmemCache",
  "enableSecurity" : false,
  "appWorkloadURL" : "http://where-for-dinner.a4.fynesy.com",
  "ployglotWorkloads" : false,
  "nativeBuild" : false,
  "includeBuildToolWrapper" : true,
  "gatewayName" : "wfd14",
  "numRabbitMQClusterNodes" : 1,
  "bsGitRepository" : "github.com?owner=tfynes-pivotal&repo=wfd14"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","gatewayName":"wfd14","bsGitRepository":"github.com?owner=tfynes-pivotal&repo=wfd14","dynamicMsgBroker":false,"dbType":"h2","empty":"","nativeBuild":false,"enableSecurity":false,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"wfd-rmq","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.a4.fynesy.com","artifactId":"wfda4","serviceNamespace":"default","projectName":"wfda4","workloadNamespace":"default","msgBrokerType":"rabbitmq","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input5387880110632756751, --data-values-file, /tmp/accelerator-options1392886518118350840.json, --output-files, /tmp/ytt-output13437039869616029728]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","gatewayName":"wfd14","bsGitRepository":"github.com?owner=tfynes-pivotal&repo=wfd14","dynamicMsgBroker":false,"dbType":"h2","empty":"","nativeBuild":false,"enableSecurity":false,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"wfd-rmq","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.a4.fynesy.com","artifactId":"wfda4","serviceNamespace":"default","projectName":"wfda4","workloadNamespace":"default","msgBrokerType":"rabbitmq","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input6304675630118055536, --data-values-file, /tmp/accelerator-options4982389229114040920.json, --output-files, /tmp/ytt-output11832212481529403619]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","gatewayName":"wfd14","bsGitRepository":"github.com?owner=tfynes-pivotal&repo=wfd14","dynamicMsgBroker":false,"dbType":"h2","empty":"","nativeBuild":false,"enableSecurity":false,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"wfd-rmq","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.a4.fynesy.com","artifactId":"wfda4","serviceNamespace":"default","projectName":"wfda4","workloadNamespace":"default","msgBrokerType":"rabbitmq","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input10609771753169403377, --data-values-file, /tmp/accelerator-options7643274755875725434.json, --output-files, /tmp/ytt-output5394322793308337047]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=tfynes-pivotal&repo=wfd14'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","gatewayName":"wfd14","bsGitRepository":"github.com?owner=tfynes-pivotal&repo=wfd14","dynamicMsgBroker":false,"dbType":"h2","empty":"","nativeBuild":false,"enableSecurity":false,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"wfd-rmq","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.a4.fynesy.com","artifactId":"wfda4","serviceNamespace":"default","projectName":"wfda4","workloadNamespace":"default","msgBrokerType":"rabbitmq","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input11372582425948509612, --data-values-file, /tmp/accelerator-options12487249399159367355.json, --output-files, /tmp/ytt-output3901626277924062980]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","gatewayName":"wfd14","bsGitRepository":"github.com?owner=tfynes-pivotal&repo=wfd14","dynamicMsgBroker":false,"dbType":"h2","empty":"","nativeBuild":false,"enableSecurity":false,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"wfd-rmq","numRabbitMQClusterNodes":1,"secureProfile":"secure","appWorkloadURL":"http://where-for-dinner.a4.fynesy.com","artifactId":"wfda4","serviceNamespace":"default","projectName":"wfda4","workloadNamespace":"default","msgBrokerType":"rabbitmq","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input8407150714678053901, --data-values-file, /tmp/accelerator-options2355940567307838904.json, --output-files, /tmp/ytt-output18228981029899597844]
